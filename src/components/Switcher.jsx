...
function Switcher() {
  ...
  document.querySelector('button').classList.add('switcher'); // side effect
  ...
  return (
    // JSX( React Element)
    <button type="button" onClick={handleClick}></button>// React.ReactNode JSX + null, string, number
